    ...
    <div class="container-fluid">
        <div class="row page-titles">
            ...
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/certificate" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Назад</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="card">
                    <div class="card-block">
                        ...
                        @endif
                        @if($row->certificate_id > 0)
                            <form action="/admin/certificate/{{$row->certificate_id}}" method="POST">
                                ...
                                @else
                                    <form action="/admin/certificate" method="POST">
                                        ...
                                        <input type="hidden" class="image-name" id="certificate_image" name="certificate_image" value="{{ $row->certificate_image }}"/>
                                            ...
                                            <div class="tab-content tabcontent-border">
                                                <div class="tab-pane active" id="ru" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $row->certificate_name_ru }}" type="text" class="form-control" name="certificate_name_ru" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane " id="kz" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            <label>Название</label>
                                                            <input value="{{ $row->certificate_name_kz }}" type="text" class="form-control" name="certificate_name_kz" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane " id="en" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            <label>Название</label>
                                                            <input value="{{ $row->certificate_name_en }}" type="text" class="form-control" name="certificate_name_en" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="card-block">
                        <div class="box box-primary" style="padding: 30px; text-align: center">
                            <div style="padding: 20px; border: 1px solid #c2e2f0">
                                <img class="image-src" src="{{ $row->certificate_image }}" style="width: 100%; "/>
                            </div>
