        ...
        <div class="row page-titles">
            <div class="col-md-8 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab">
                    <a href="/admin/menu" class="@if(!isset($request->active) || $request->active == '1') active-page @endif">Активные страницы</a>
                </h3>
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab second-tab" >
                    <a href="/admin/menu?active=0" class="@if($request->active == '0') active-page @endif">Неактивные страницы</a>
                </h3>
                    ...
                    <table id="menu_datatable" class="table table-bordered table-striped">
                        ...
                        @foreach($row as $key => $val)
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <a href="/admin/menu/{{ $val->menu_id }}/edit">
