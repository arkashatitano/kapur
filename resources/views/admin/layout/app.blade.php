<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="16x16" href="/img/favicon.png?v=5">
  <title>Админка</title>
  <!-- Bootstrap Core CSS -->
  ...
  <link href="/admin/assets/plugins/bootstrap-select/bootstrap-select.min.css" rel="stylesheet" />
  ...
  <link href="/admin/css/colors/blue.css" rel="stylesheet">
