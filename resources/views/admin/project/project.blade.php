        ...
        <div class="row page-titles">
            <div class="col-md-8 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab">
                    <a href="/admin/project" class="@if(!isset($request->active) || $request->active == '1') active-page @endif">Опубликованные проекты</a>
                </h3>
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab second-tab" >
                    <a href="/admin/project?active=0" class="@if($request->active == '0') active-page @endif">Неопубликованные проекты</a>
                </h3>
                <div class="clear-float"></div>
            </div>
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/project/create" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Добавить</a>
            </div>
        </div>
            ...
            <div style="text-align: left" class="form-group col-md-6" >
                ...
                @if($request->active == '0')
                    ...
                    <h4 class="box-title box-edit-click">
                        <a href="javascript:void(0)" onclick="isShowEnabledAll('project')">Опубликовать отмеченные</a>
                    </h4>

                @else

                    <h4 class="box-title box-edit-click">
                        <a href="javascript:void(0)" onclick="isShowDisabledAll('project')">Неопубликовать отмеченные</a>
                    </h4>
                ...
                <div class="box-body">
                    <table id="project_datatable" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <form>
                                     <input value="{{$request->project_name}}" type="text" class="form-control" name="project_name" placeholder="">
                        ...
                        @foreach($row as $key => $val)
                            ...
                            <tr>
                                <td> {{ $key + 1 }}</td>
                                <td>
                                    <a target="_blank" href="{{ $val['project_url_ru']}}">
                                        {{ $val['project_name_ru']}}
                                    </a>
                                </td>
                                <td>
                                    @if($val->project_pdf != '')
                                        <a target="_blank" href="{{$val->project_pdf}}">
                                            Скачать файл
                                        </a>
                                    @endif
                                </td>
                                ...
                                <td style="text-align: center">
                                    <a href="javascript:void(0)" onclick="delItem(this,'{{ $val->project_id }}','project')">
                                        <i class="mdi mdi-delete" style="font-size: 20px; color: red;"></i>
                                    </a>
                                </td>
                                <td style="text-align: center">
                                    <a href="/admin/project/{{ $val->project_id }}/edit">
                                        <i class="mdi mdi-grease-pencil" style="font-size: 20px;"></i>
                                    </a>
                                </td>
                                <td style="text-align: center;">
                                    <input class="select-all" style="font-size: 15px" type="checkbox" value="{{$val->project_id}}"/>
                                </td>
                            </tr>
