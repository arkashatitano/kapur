    ...
    <div class="container-fluid">
        <div class="row page-titles">
            ...
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/slider" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Назад</a>
            </div>
        </div>
        <div class="row">
                            ...
                            <form action="/admin/slider/{{$row->slider_id}}" method="POST">
                                ...
                                @else
                                    <form action="/admin/slider" method="POST">
                                        ...
                                        <input type="hidden" class="image-name" id="slider_image" name="slider_image" value="{{ $row->slider_image }}"/>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="tab-content tabcontent-border">
                                                <div class="tab-pane active" id="ru" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $row->slider_name_ru }}" type="text" class="form-control" name="slider_name_ru" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Описание</label>
                                                            <textarea name="slider_text_ru" class="form-control"><?=$row->slider_text_ru?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane " id="kz" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            <label>Название</label>
                                                            <input value="{{ $row->slider_name_kz }}" type="text" class="form-control" name="slider_name_kz" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Описание</label>
                                                            <textarea name="slider_text_kz" class="form-control"><?=$row->slider_text_kz?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane " id="en" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            <label>Название</label>
                                                            <input value="{{ $row->slider_name_en }}" type="text" class="form-control" name="slider_name_en" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Описание</label>
                                                            <textarea name="slider_text_en" class="form-control"><?=$row->slider_text_en?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>Ссылка</label>
                                                <input value="{{ $row->slider_redirect }}" type="text" class="form-control" name="slider_redirect" placeholder="">
                                            </div>
                                            <div class="form-group">
