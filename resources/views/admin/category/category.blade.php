        ...
        <div class="row page-titles">
            <div class="col-md-8 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab">
                    <a href="/admin/category" class="@if(!isset($request->active) || $request->active == '1') active-page @endif">Опубликованные категории</a>
                </h3>
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab second-tab" >
                    <a href="/admin/category?active=0" class="@if($request->active == '0') active-page @endif">Неопубликованные категории</a>
                </h3>
                <div class="clear-float"></div>
            </div>
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/category/create" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Добавить</a>
            </div>
        </div>
            ...
            <div style="text-align: left" class="form-group col-md-6" >
                ...
                @if($request->active == '0')
                    ...
                    <h4 class="box-title box-edit-click">
                        <a href="javascript:void(0)" onclick="isShowEnabledAll('category')">Опубликовать отмеченные</a>
                    </h4>

                @else

                    <h4 class="box-title box-edit-click">
                        <a href="javascript:void(0)" onclick="isShowDisabledAll('category')">Неопубликовать отмеченные</a>
                    </h4>
                ...
                <div class="box-body">
                    <table id="category_datatable" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <form>
                                     <input value="{{$request->category_name}}" type="text" class="form-control" name="category_name" placeholder="">
                        ...
                        @foreach($row as $key => $val)
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <a href="/admin/category/{{ $val->category_id }}/edit">
