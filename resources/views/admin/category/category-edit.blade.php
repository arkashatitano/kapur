                            ...
                            <form action="/admin/category/{{$row->category_id}}" method="POST">
                                ...
                                @else
                                    <form action="/admin/category" method="POST">
                                        ...
                                        <input type="hidden" class="image-name" id="category_image" name="category_image" value="{{ $row->category_image }}"/>
                                            ...
                                            <div class="tab-content tabcontent-border">
                                                <div class="tab-pane active" id="ru" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $row->category_name_ru }}" type="text" class="form-control" name="category_name_ru" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane " id="kz" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            <label>Название</label>
                                                            <input value="{{ $row->category_name_kz }}" type="text" class="form-control" name="category_name_kz" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane " id="en" role="tabpanel">
                                                    <div class="card-block">
                                                        <div class="form-group">
                                                            <label>Название</label>
                                                            <input value="{{ $row->category_name_en }}" type="text" class="form-control" name="category_name_en" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
